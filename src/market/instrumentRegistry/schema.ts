...
export const SEED_INSTRUMENTS: readonly Instrument[] = Object.freeze([
    ...
    },
    {
        key: 'XRP/USD',
        base: { currency: 'XRP' },
        quote: { currency: 'USD', issuer: 'rcEGREd8NmkKRE8GE424sksyt1tJVFZwu' },
        description: 'XRP/USD (GateHub)',
        liquidity: 'high' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 3,
    ...
    },
    {
        ...
        description: 'XRP/USD (GateHub Fifth)',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 7,
    ...
    },
    {
        key: 'XRP/CNY',
        base: { currency: 'XRP' },
        quote: { currency: 'CNY', issuer: 'rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y' },
        description: 'XRP/CNY',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
    ...
    },
    {
        key: 'XRP/XLM',
        base: { currency: 'XRP' },
        quote: { currency: 'XLM', issuer: 'rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y' },
        description: 'XRP/XLM',
        liquidity: 'low' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 13,
        createdAt: '2025-01-01T00:00:00.000Z',
    ...
    },
    {
        ...
        description: 'XRP/EUR (Bitstamp IOU)',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 2,
    ...
    },
    {
        ...
        description: 'XRP/BTC (GateHub IOU)',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 5,
    ...
    },
    {
        ...
        description: 'XRP/SOLO (Sologenic)',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 6,
    ...
    },
    {
        key: 'XRP/CSC',
        base: { currency: 'XRP' },
        quote: { currency: 'CSC', issuer: 'rCSCManTZ8ME9EoLrSHHYKW8PPwWMgkwr' },
        description: 'XRP/CSC (CasinoCoin)',
        liquidity: 'medium' as LiquidityLevel,
        network: 'mainnet' as Network,
        status: 'active' as RegistryStatus,
        sortOrder: 7,
...
export const SEED_ISSUERS: readonly IssuerRecord[] = Object.freeze([
    ...
    {
        address: 'rcoreNywaoz2ZCQ8Lg2EbSLnGuRBmun6D',
        label: 'Coreum',
        currency: 'CORE',
        tier: 'tier2' as IssuerTier,
        network: 'mainnet' as Network,
